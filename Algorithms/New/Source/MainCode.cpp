...
namespace
{
	...
	const char* const WINDOW_TITLE = "7-1 FinalProject and Milestones - Milestone 5 - Jacob Gilliam"; 
...
int main(int argc, char* argv[])
{
	...
	while (!glfwWindowShouldClose(g_Window))
	{
		...
		// Grab the current camera matrices
		glm::mat4 viewProjection = g_ViewManager->PrepareSceneView();

		// Pass the combined matrix to your optimized render loop
		g_SceneManager->RenderScene(viewProjection);
